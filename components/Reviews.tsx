...
// ⚠️ المسار /share-experience يعيش الآن في app/(ar)/ بعد إعادة هيكلة Wave 1 —
//    مجموعة المسارات لا تظهر في الرابط، فالرابط نفسه لم يتغيّر.
...
/**
 * V2-1.5-A · V2-4.2-D — البوّابة، وهي مُبقاة من Wave 1 حرفيًّا.
 *
 * ★ لماذا مكوّنان لا واحد ★
 * الحارس **قبل** الخطّافات. النسخة القادمة من فرع المنصّة كانت تستدعي
 * `fetchPublicTestimonials` داخل `useEffect` بلا شرط — أي أنّ العلم المطفأ كان
 * سيُصدر طلب شبكة على كلّ زيارة للصفحة الرئيسية مقابل قسم لا يُعرض. وقاعدة
 * الأعلام صريحة: خلف علم مطفأ **لا طلب شبكة ولا واجهة فارغة**.
 *
 * والخطّافات لا تُستدعى شرطيًّا، فالحلّ تقسيم لا شرط داخل الخطّاف: هذا المكوّن
 * يقرّر، و`ReviewsSection` يملك الحالة. والقيمة ثابتة وقت البناء
 * (`NEXT_PUBLIC_*`) فيُحذف الفرع كلّه من الحزمة.
 */
