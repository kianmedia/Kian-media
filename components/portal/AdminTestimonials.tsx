...
export default function AdminTestimonials() {
  ...
  // ⚠️ كان `load` دالّةً عادية مع `/* eslint-disable-next-line */` **داخل** جسم
  // الـuseEffect — أي أنّه يعطّل السطر التالي لا سطر التبعيات، فلم يكن يفعل شيئًا
  // والتحذير باقٍ. الصواب تثبيت الهويّة بـuseCallback بدل إخفاء التحذير.
