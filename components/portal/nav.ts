...
const SETS: Record<ViewRole, string[]> = {
  admin:       ["overview", "projects", "quotes", "messages", "files", "accounts", "staff", "employee", "whatsapp", "opportunities", "equipment", "invoices", "notifications", "profile"],
  super_admin: ["overview", "projects", "quotes", "messages", "files", "staff", "employee", "whatsapp", "opportunities", "equipment", "invoices", "notifications", "profile"],
  manager:     ["overview", "projects", "quotes", "messages", "files", "employee", "whatsapp", "opportunities", "equipment", "invoices", "notifications", "profile"],
  ...
  finance:     ["employee", "invoices", "whatsapp", "equipment", "notifications", "profile"],
  ...
  custody_officer:  ["employee", "equipment", "notifications", "profile"],
