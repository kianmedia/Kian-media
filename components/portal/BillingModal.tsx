...
const FAIL: Record<string, { ar: string; en: string }> = {
  ...
  missing_service_role_env:   { ar: "إعدادات الخادم غير مكتملة لتجهيز حساب الفوترة.", en: "Server isn't fully configured to prepare the billing account." },
  ensure_client_failed:       { ar: "تعذّر تجهيز حساب الفوترة على الخادم. حاول مجددًا، وإن استمرّت المشكلة تواصل مع فريق كيان.", en: "Couldn't prepare the billing account on the server. Please retry." },
  quote_read_failed:          { ar: "تعذّر قراءة بيانات العرض. حدّث الصفحة وحاول مجددًا.", en: "Couldn't read the quote. Refresh and retry." },
  sync_write_failed:          { ar: "تعذّر حفظ حالة المزامنة. حاول مجددًا.", en: "Couldn't save the sync state. Retry." },
