...
8. **`docs/custody_inventory_asset_soft_delete_PATCH.sql`** — يضيف الحذف/الاستعادة الآمن (admin فقط) + قائمة المحذوفات + قواعد المنع.
...
- الحذف/الاستعادة/قائمة المحذوفات: **دور admin الحقيقي فقط** (`account_type='admin'` نشط) — مُنفَّذ داخل الدوال، لا بإخفاء الواجهة.
