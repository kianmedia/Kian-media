-- ════════════════════════════════════════════════════════════════════════
-- Kian Portal — PRODUCTION HOTFIX: quote/project fixes ONLY (RUN ONCE)
-- Self-contained, idempotent, safe to rerun. Depends only on the base phase-0
-- schema (clients, projects, project_members, profiles, is_admin(), my_client_id(),
-- soft_delete) — NO media/preview/final tables, NO WhatsApp/email/Zoho/notification
-- objects, NO storage buckets. Includes ONLY the project-creation/linking flow +
-- the pending-client placeholder-email support.
--
