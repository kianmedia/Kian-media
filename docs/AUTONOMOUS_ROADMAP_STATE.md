...
| **P2** | Privileged Account MFA (TOTP) | `IN_PROGRESS` | P2.0 تدقيق | تدقيق 7 محاور + 3 حقائق حاسمة أثبتُّها بنفسي (أسفل) | استلام خطة التدقيق ثم P2.1 | — | — | — | — | `M-003` تسجيل المالك | 2026-07-27 |
