...
| **P2** | Privileged Account MFA (TOTP) | `IN_PROGRESS` | **S2 تسجيل TOTP** | S1 `a7efad0` · S1b `9f42721` · **M-009 = PASS: `aal=aal1` من جلسة حقيقية** ⇒ بوّابات SQL ممكنة | S2 عميل GoTrue REST + واجهة التسجيل، ثم S3، ثم تصميم S4 | `9f42721` | ⏸️ `M-000` | S1 مُطبَّق · S1b بانتظار | 902/902 | `M-008` تفعيل TOTP بلوحة Supabase · `M-003` تسجيل المالك | 2026-07-28 |
