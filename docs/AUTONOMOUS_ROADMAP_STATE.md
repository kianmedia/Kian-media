...
| **P1** | العمود الفقري: البريد والإشعارات | `IN_PROGRESS` | **P1.2 صحّة تسليم العامل** | P1.0 ✅ `2910c10` · P1.1 ✅ `75fa3b5` · تتبّع الرحلات الثماني ✅ `cb3156b` | نفّذ P1.2 (تفصيله أسفل الجدول) | `cb3156b` | ⏸️ `M-000` | ❌ SQL لم يُطبَّق | 795/795 | `M-005` SQL · `M-002` Apps Script | 2026-07-27 |
...
| P1.3 إيقاف تقرير «أخضر» أثناء انقطاع كامل | ✅ `814c4b4` — **SQL لم يُطبَّق (`M-006`)** |
| **P1.4 إزالة مسارات التجاوز والازدواج** | ⏭️ **التالي** |
| P1.5 استعادة نسبة الحدث في المراقبة والتتبّع | ⏳ |
| P1.6 صدق النجاح في النماذج العامة | ⏳ |
