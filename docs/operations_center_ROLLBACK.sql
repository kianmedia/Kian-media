...
--   التعداد كان يرفض 'ops_job' فيُفقَد كلّ إشعار تشغيل بصمت. إعادة التعداد هنا
--   كانت ستكسر المبيعات أيضًا (crm_opportunity) وكلّ موديول لاحق. القيد الشكليّ
--   أوسع من التعداد، فلا صفّ قائم يخالفه، وتركه لا يترك أثرًا لهذا الموديول.
-- ════════════════════════════════════════════════════════════════════════════
